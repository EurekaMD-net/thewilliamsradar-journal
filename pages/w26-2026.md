...
## Signal Exit Analysis — W25

> 🔴 ANALYSIS — Of the 14 names that lost signal, how many exited on real appreciation vs. noise?

| Ticker | Δ% | Exit Reason | Verdict |
|--------|----|-----------|---------| 
| **RARE** | +12.1% | AC crossed positive | ✅ Real appreciation |
| **CAG** | +6.7% | AC crossed positive | ✅ Real appreciation |
| **DASH** | +5.6% | AC crossed positive | ✅ Real appreciation |
| **DHI** | +5.4% | AC crossed positive | ✅ Real appreciation |
| **XYL** | +4.5% | AC crossed positive | ✅ Real appreciation |
| **HD** | +4.4% | AC crossed positive | ✅ Real appreciation |
| **FE** | +4.3% | AC crossed positive | ✅ Real appreciation |
| **FMC** | +1.7% | AC crossed positive | ⚠️ Range — move without conviction |
| **LMT** | -0.7% | AC turned red | 🔴 Collapse — deterioration, not resolution |
| **HUBB** | -1.3% | AC crossed positive | ❌ Technical false signal — AC technical, price fell |
| **BSX** | -2.3% | AC turned red | 🔴 Collapse — deterioration, not resolution |
| **NOC** | -4.1% | AC turned red | 🔴 Collapse — deterioration, not resolution |
| **META** | -4.7% | AC turned red | 🔴 Collapse — deterioration, not resolution |
| **NEM** | -7.4% | AC turned red | 🔴 Collapse — deterioration, not resolution |

**Summary: 7 real appreciation (50%) · 1 range (7%) · 6 no price support or deterioration (43%)**

Notable: **NEM** (-7.4%) didn't lose the signal because the setup resolved — it lost it because the deterioration deepened. Worth monitoring in W26 as a continuation of negative momentum.
